...
An important aspect of the planning for this project was the element of User-Experience. 
Directing the planning of the project through a User-Experience approach created a useful 
guide to understand the user's needs and streamline the development of the site. Through 
visiting Petiole, it was important to create a positive user experience.
...
- The goal was an overall cohesive feeling to the website so I decided not to use multiple fonts.
- I wanted something contemporary but also clean & clear. 
- The font was chosen from [Google Fonts](https://fonts.google.com/) to make sure it worked across browsers/devices.
...
### Search
- Ability to search for specific plants
...
- **As a user, I want to easily login**
  - The login link is clearly on the nagivational menu.
...
This project has been deployed using Heroku and I have used the following process to do so:
